				...
				if (inv.get_Value("WithholdingAmt") == null) {
					...
					if (genwh != null) {
						...
						if (genwh.equals("Y")) {
							...
							if (inv.isSOTrx() && MSysConfig.getBooleanValue("LCO_VALIDATE_WITHOLDING_ON_SALES", true,
									inv.getAD_Client_ID()))
							...
							if (!inv.isSOTrx() && MSysConfig.getBooleanValue("LCO_VALIDATE_WITHOLDING_ON_PURCHASES",
									true, inv.getAD_Client_ID()))
								// document type configured to compel generation of withholdings
								throw new RuntimeException(Msg.getMsg(inv.getCtx(), "LCO_WithholdingNotGenerated"));
						}
						if (genwh.equals("A")) {
